# -*- coding: utf-8 -*-
"""
Created on Mon Feb 17 12:07:59 2020
...
"""
    runof = datas.variables['prate'][372:-1]#starting month is (1979-1948)*12, end is -1 is last, last is not incl.
    runof= runof*3600*24#umrechnung pro tag
...
"""
    ...
    plt.title("Niederschlag(1979-2019)",fontsize=24)
