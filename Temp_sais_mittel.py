# -*- coding: utf-8 -*-
"""
Created on Sat Feb 22 11:51:24 2020
...
def months_sp(datas):
    """
    Transforms given data into a list of seasional mean temperatures
...
def plot_stuff(datas, mean_temp):
    """
    Creates 4 plots in 1 figure to show mean temperature for each season 
    and shows it
    ...
    for row in range(2):
        for cell in range(2):     
            ...
            plt.title("Mean Temperature "+ses[row*2+cell])
